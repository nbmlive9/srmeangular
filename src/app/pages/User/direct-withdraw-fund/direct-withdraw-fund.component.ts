...
@Component({
  selector: 'app-direct-withdraw-fund',
  templateUrl: './direct-withdraw-fund.component.html',
  styleUrls: ['./direct-withdraw-fund.component.css']
})
export class DirectWithdrawFundComponent {
    ...
    add(){
      ...
      if (this.form.valid) {
        ...
        this.api.DirectWithdrawFundUser(val).subscribe(
          (a:any) => {
            if (a) {
              // console.log(a);
                 this.form.reset();
